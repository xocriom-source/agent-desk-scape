...
export default function Signup() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      localStorage.removeItem("skipLobby");
      navigate("/spaces");
    }, 800);
  };
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gray-900 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <h2 className="text-3xl font-display font-bold text-white mb-4">
            Monte sua empresa virtual
          </h2>
          <p className="text-gray-400 text-lg max-w-sm mx-auto">
            Crie seu escritório, contrate agentes de IA e comece a produzir resultados em minutos.
          </p>
          <div className="mt-12 grid grid-cols-3 gap-4 max-w-xs mx-auto">
            {["🔬", "✍️", "💻", "📊", "🎨", "🔧"].map((emoji, i) => (
              <div
                key={i}
                className="w-14 h-14 rounded-xl bg-white/5 backdrop-blur-sm flex items-center justify-center text-2xl"
              >
                {emoji}
              </div>
            ))}
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8">
        ...
        >
          ...
          <p className="text-xs text-gray-400 text-center mt-4">
            Ao criar sua conta, você concorda com os Termos de Serviço e Política de Privacidade.
          </p>
